...
| `SQL code`        | <p> `CREATE INDEX project_member_user_index` </p> <p> `ON project_member`</p>
<p> `USING btree (user_id);` </p> <p>`CLUSTER project_member`</p> <p>`USING user_projects_member;`<p>                                                                                                                                                                                                                                                                                                                        |
